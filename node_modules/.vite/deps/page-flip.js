...
//#region node_modules/page-flip/dist/js/page-flip.browser.js
var require_page_flip_browser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		class h {
			static GetDistanceBetweenTwoPoint(t, e) {
				return null === t || null === e ? Infinity : Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2));
			}
		...
		class l {
			constructor(t, e) {
				...
				const i = /* @__PURE__ */ new RegExp("Version\\/[\\d\\.]+.*Safari/");
...
//#endregion
export default require_page_flip_browser();

//# sourceMappingURL=page-flip.js.map